...
resultsm0 = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Consolidado PEES Jan.22.xlsx", sheet_name='m0')
resultsm1 = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Consolidado PEES Jan.22.xlsx", sheet_name='m1')
resultsm2 = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Consolidado PEES Jan.22.xlsx", sheet_name='m2')
conciliacao = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Lucro Bruto')
conciliacaotime = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Time')
conciliacaoenc = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Encantamento')
conciliacaope = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Preço Estrelado')
seguros = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Seguros')
churn = pd.read_excel("G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Apuração PEES Jan.22.xlsx", sheet_name='Base Ativa')
...
for f in franchise:
    ...
    na_t = conciliacao[(conciliacao['Grupo_2'] == f) & (conciliacao['Data_de_Ativacao'] >= '2022-01-01') & (conciliacao['Data_de_Ativacao'] <= '2022-01-31')]
    na_o = na_t[['Afiliacoes_Consideradas', 'Nome_do_Cliente', 'Data_de_Ativacao', 'Email_do_Vendedor', 'Domicilio_Bancario']]
    nad_total = (resultsm0[resultsm0['FRANQUIA'] == f] ['NA COM DOMICÍLIO'])
    ...
    mig_t = conciliacao[(conciliacao['Grupo_2'] == f) & ((conciliacao['Safra_do_Cliente'] != 'M-0'))]
    mig_o = mig_t[['Mes', 'Afiliacoes_Consideradas', 'Nome_do_Cliente', 'Safra_do_Cliente', 'TPV_Precificado', 'TPV', 'Migração', '70%+']]
    tpvp_total = float(resultsm0[resultsm0['FRANQUIA'] == f]['TOTAL CLIENTES'])
    tpvt_total = float(resultsm0[resultsm0['FRANQUIA'] == f]['CLIENTES 70%+'])


    p_t = conciliacaope[(conciliacaope['str_group_2'] == f) & (conciliacaope['dt_activation_date'] >= '2022-01-01') & (conciliacaope['dt_activation_date'] <= '2022-01-31') & (conciliacaope['Preço +1 estrela'] != 0)]
    p_o = p_t[['str_afiliacoes_consideradas', 'str_client_name', 'dt_affiliation_date', 'str_affiliator_vendor_email', 'Preço +1 estrela']]
    clientes1 = p_o.loc[p_o['Preço +1 estrela'] == 1, 'Preço +1 estrela'].count()
    clientes2 = p_o.loc[p_o['Preço +1 estrela'] == 2, 'Preço +1 estrela'].count()
    clientes3 = p_o.loc[p_o['Preço +1 estrela'] == 3, 'Preço +1 estrela'].count()
    clientes4 = p_o.loc[p_o['Preço +1 estrela'] == 4, 'Preço +1 estrela'].count()
    clientes5 = p_o.loc[p_o['Preço +1 estrela'] == 5, 'Preço +1 estrela'].count()
    clientest = clientes1 + clientes2 + clientes3 + clientes4 + clientes5


    encantamento = conciliacaoenc[(conciliacaoenc['Grupo_2'] == f) & (((conciliacaoenc['Semana_S_2'] >= '2021-12-26') & (conciliacaoenc['Semana_S_2'] <= '2022-01-31')))]
    encantamento_o = encantamento[['Afiliacoes_Consideradas', 'Grupo_3', 'Email_do_Vendedor', 'Data_de_Cadastro', 'Semana_de_Cadastro', 'Semana_S_2', 'Mês_S_2', 'Visitas_S_2_Planejadas', 'Visitas_S_2_Finalizadas']]

    d15p = (resultsm0[resultsm0['FRANQUIA'] == f]['VISITAS PLANEJADAS'])
    d15r = (resultsm0[resultsm0['FRANQUIA'] == f]['VISITAS REALIZDAS'])
    ...
    segurost = seguros[(seguros['Franquia'] == f)]
    ...
    with pd.ExcelWriter(f"G:\\Drives compartilhados\\Gente e Gestão FVT\\Lucas\\2022\\03. Fechamentos\\05. PEES\\Jan.22\\Arquivos 2\\Apuração PEES Jan.22 - {f}.xlsx") as writer:
        ...
        worksheet.conditional_format('G19:G20', {'type': 'cell',
                                             'criteria': 'between',
                                             'minimum': 30,
                                             'maximum': 49,
        ...
        worksheet.merge_range('D19:F20', 'NOTA DO MÊS:', format_baixo)
        worksheet.merge_range('G19:G20', final_gradem0, format_nota)
        worksheet.merge_range('D21:F22', 'POSIÇÃO:', format_posicao)
        worksheet.merge_range('G21:G22', position, format_posicao2)
        worksheet.merge_range('I11:J11', 'Dezembro', format_cima)
        worksheet.merge_range('I12:J12', 'Novembro', format_cima)
        worksheet.merge_range('I13:J13', 'Média 3 meses:', format_cima)
        worksheet.merge_range('J18:M18', franchise[0], format_cima)
        worksheet.merge_range('J19:M19', franchise[1], format_cima)
        worksheet.merge_range('J20:M20', franchise[2], format_cima)
        worksheet.merge_range('J21:M21', franchise[3], format_cima)
        worksheet.merge_range('J22:M22', franchise[4], format_cima)
        ...
        worksheet.write_formula('C18', '80', format_percent)
        ...
        worksheet.merge_range('D23:G24', f'Desafio HC Efetivo: {round(hc_d_m0/21)}*21 = {round(hc_d_m0/21)*21} (Meta HC * 21 dias úteis)', format_cima1)
        worksheet.merge_range('D25:H26', f'Se você é Empreendedor Stone, o atingimento de novos ativos se refere a meta de orçamento.', format_cima1)
        ...
        writer.sheets['HC Efetivo'].write('I1', 'Ativo', format_sheets_titulo)
        ...
        for agente in range(0,len(df2)):
            ...
            writer.sheets['HC Efetivo'].write_formula(agente+1,2, f'=(B{agente+2}/21)', percentage)
        # </editor-fold>
        ...
        writer.sheets['Migração'].set_column("H:H", 20, center)
        writer.sheets['Migração'].autofilter('A1:C1')
        writer.sheets['Migração'].autofilter('A5:H5')
        writer.sheets['Migração'].set_zoom(80)
        writer.sheets['Migração'].write('A1', 'Total Clientes', format_sheets_titulo2)
        writer.sheets['Migração'].write('B1', 'Clientes Migrados 70%+', format_sheets_titulo2)
        writer.sheets['Migração'].write('C1', '%', format_sheets_titulo2)
        writer.sheets['Migração'].write('A2', tpvp_total, format_sheets)
        writer.sheets['Migração'].write('B2', tpvt_total, format_sheets)
        ...
        writer.sheets['Preço Estrelado'].write_formula('C2', '=B2/B7', percentage)
        writer.sheets['Preço Estrelado'].write_formula('C3', '=B3/B7', percentage)
        writer.sheets['Preço Estrelado'].write_formula('C4', '=B4/B7', percentage)
        writer.sheets['Preço Estrelado'].write_formula('C5', '=B5/B7', percentage)
        writer.sheets['Preço Estrelado'].write_formula('C6', '=B6/B7', percentage)
        ...
        writer.sheets['Preço Estrelado'].write('E9', 'Preço Estrelado (+1 contrato)', format_sheets_titulo)
        # </editor-fold>
        ...
        writer.sheets['Encantamento'].autofilter('A6:I6')
        writer.sheets['Encantamento'].set_zoom(80)
        writer.sheets['Encantamento'].write('A2', 'D+15', format_sheets_titulo2)
        writer.sheets['Encantamento'].write('B1', 'Realizados', format_sheets_titulo2)
        writer.sheets['Encantamento'].write('C1', 'Planejados', format_sheets_titulo2)
        ...
        writer.sheets['Encantamento'].write_formula('D2', '=B2/C2', percentage)
